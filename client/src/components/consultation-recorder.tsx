...
import { Mic, Square, Pause, Play, Brain } from "lucide-react";
...
export default function ConsultationRecorder({ onClose, selectedPatientId }: ConsultationRecorderProps) {
  ...
  const processAudio = async (audioBlob: Blob) => {
    try {
      ...
      await analyzeConsultation(text);
  ...
  const analyzeConsultation = async (transcriptionText: string) => {
    try {
      setIsAnalyzing(true);
      ...
      if (analysisResult.consultation || analysisResult.prescription) {
        toast({ 
          ...
          description: analysisResult.prescription ? "Prescription created and pending review" : "Consultation recorded"
        });
  ...
  return (
    <Card>
      <CardContent className="p-6">
        <h2 className="text-xl font-semibold text-primary mb-6">AI-Powered Consultation Recording</h2>
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            {isAnalyzing ? (
              <div className="flex items-center justify-center py-4">
                ...
                <span className="ml-2 text-sm text-muted-foreground">Analyzing consultation...</span>
              </div>
            ) : analysis ? (
                ...
                {analysis.conversationAnalysis && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div className="bg-white rounded-lg p-3">
                      <p className="font-medium text-blue-600 mb-2">👨‍⚕️ Doctor Statements:</p>
                    ...
                    <div className="bg-white rounded-lg p-3">
                      <p className="font-medium text-green-600 mb-2">👤 Patient Statements:</p>
                      <ul className="text-muted-foreground space-y-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  {analysis.prescriptionNeeded && (
                    <div className="md:col-span-2">
                      <p className="font-medium text-primary mb-1">Prescription Needed:</p>
