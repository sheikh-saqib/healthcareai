        ...
        <div ref={printRef}>
          ...
          <CardContent className="prescription-content space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                {formatMedications(prescription.medications).map((med: any, index: number) => (
            ...
            <div className="signature-section">
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-sm text-center">Date: {formatDate(prescription.updatedAt)}</p>
                </div>
                <div>
            ...
            <div className="text-center text-xs text-gray-500 mt-8 pt-4 border-t">
              ...
              <p className="mt-2">Generated by Medical Consultation System - {formatDate(new Date())}</p>
            </div>
          </CardContent>
        </div>
      </Card>
